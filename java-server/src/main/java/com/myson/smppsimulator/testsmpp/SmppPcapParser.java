...
package com.myson.smppsimulator.testsmpp;
...
import com.myson.smppsimulator.service.SmppAccepter;
...
public class SmppPcapParser {
    ...
    public SmppPcapParser(SmppAccepter smppAccepter, InputStream file, int port) {
